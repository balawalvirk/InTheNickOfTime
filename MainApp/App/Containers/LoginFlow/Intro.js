                    ...
                    <View style={styles.lowerContainer}>
                        <View style={{ flex: 1, width: width(95), alignItems: 'center', backgroundColor: 'transparent', marginTop: height(5) }}>
                            ...
                            <View style={[styles.txtContainer, {}]}>
                                ...
                                Thank you for your interest in signing up to work with us! ​
In the Nick of Time: The Elite Mobile Salon Spa provides clients beauty and wellness services on location.
 Clients receive services at their home, office, hospital, event or wedding. ​
Technicians are independent contractors and are required to sustain liability
 insurance and a license or certification to provide their offered services.​
