                    ...
                    <View style={styles.lowerContainer}>
                        <View style={{ flex: 1, width: width(85), alignItems: 'center', backgroundColor: 'transparent', marginTop: height(5) }}>
                            ...
                            <View style={[styles.txtContainer, {}]}>
                                ...
                                <Text style={[styles.welcome, { fontSize: totalSize(2) }]}>Once you sign up, and have been accepted to receive clients with In the Nick of Time, you will receive an e-mail with additional links to complete your W9, direct deposit and to submit liability insurance. You will also receive a username and password to create your own profile on the app</Text>
