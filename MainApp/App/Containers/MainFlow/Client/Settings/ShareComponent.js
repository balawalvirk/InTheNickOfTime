...
export default class ShareComponent extends Component {
  ...
  render() {
    ...
    let shareOptions = {
      title: "React Native",
      message: "Hi there - In The Nick Of Time",
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.mainBtn} onPress={this.onOpen.bind(this)}>
          <View style={styles.btnIconContainer}>
            <View style={styles.IconContainer}>
              <IconI name="md-share" size={totalSize(2)} color='white' />
            </View>
          </View>
            ...
            <SafeAreaView style={styles.modalOuterContentContainer}>
              <View style={[styles.modalInnerContentContainer, {flex: this.props._flex}]}>
                <TouchableOpacity style={styles.close} onPress={() => {
                  ...
                  <Icon name="close" color={'#71a1ed'} size={35}/>
                </TouchableOpacity>
