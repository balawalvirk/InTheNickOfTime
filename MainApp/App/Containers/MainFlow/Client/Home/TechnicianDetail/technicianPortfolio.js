...
class TechnicianPortfolio extends Component {
  constructor(props) {
    super(props);
    let url =
      "https://firebasestorage.googleapis.com/v0/b/inthenameoftimespa-f27fa.appspot.com/o/assets%2Fgh6mjc6vdJ5AQOnjMw3P-97351638.png?alt=media&token=26b70620-4833-4044-b105-5e8de3128861";
    this.state = {
      images_list: []
    };
  }
  ...
  async fetchOrder() {
    ...
    let TechnicianList = await firebase
      ...
      .where(
        "UserId",
        "==",
        this.props.navigation.getParam("technician", "").UserId
      )
      .get();
    ...
    return (
      <View style={styles.container}>
        {this.state.isDataLoded ? (
          this.state.portfolio_array !== undefined &&
