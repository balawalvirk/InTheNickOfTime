      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.container}>
          ...
          <View style={styles.uperContainer}>
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("editProfileTechnician")
              }
              style={{
                width: totalSize(6),
                height: totalSize(6),
                      ...
                      onPress={() => {
                        if (this.state.index != index) {
                          const a = Object.assign(
                            {},
                            this.state.days[this.state.index]
                          );
                          a.color = "#000";
                          const currentIndex = Object.assign(
                            {},
          ...
          >
            <View>
              <View style={styles.popUpTop}>
                ...
                <TouchableOpacity
                  onPress={this._toggleModalLocation}
                  ...
                  <View style={styles.inputTxtContainer}>
                    ...
                    >
                      ...
                      >
                        ...
                        {this.state.states_list[this.state.Cindex - 1]
                          .SubList !== undefined &&
                        this.state.states_list[this.state.Cindex - 1].SubList
                          .length > 0
                          ? this.state.states_list[
                              this.state.Cindex - 1
